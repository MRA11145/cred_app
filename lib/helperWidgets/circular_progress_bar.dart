import 'package:cred_app/utils/media_query.dart';
...
class _CircularProgressBarState extends State<CircularProgressBar> {
        ...
        children: [
          ...
          Positioned.fill(
            child: Center(
              ...
              children: [
                CommonWidgets.FontWidget(StringConstants.creditAmount, Colors.white.withOpacity(0.7), FontWeight.w400, "Roboto", FontStyle.normal, 60, TextAlign.left),
                SizedBox(
  ...
  void _updateProgress(Offset localPosition) {
    ...
    setState(() {
      ...
      finalValue = (widget.startValue + (widget.endValue - widget.startValue) * progress).ceil();
...
class _CircularProgressBarClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.lineTo(center.dx + radius * math.cos(startAngleRadians), center.dy + radius * math.sin(startAngleRadians));
    path.arcTo(Rect.fromCircle(center: center, radius: radius), startAngleRadians, endAngleRadians - startAngleRadians, false);
