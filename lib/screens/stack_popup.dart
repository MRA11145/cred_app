...
class StackPopup extends StatefulWidget {
  ...
  StackPopup({Key? key, required this.slideController, required this.slideAnimation, required this.animCompleteCallback, required this.animReversedCallBack , required this.child, required this.screenNumber}) : super(key: key);
      ...
      child: AnimatedBuilder(
        ...
        builder: (context, child) {
          return Transform.translate(
            offset: Offset(0.0, MediaQuery.of(context).size.height * (1 - widget.slideAnimation.value)),
            child: Container(
