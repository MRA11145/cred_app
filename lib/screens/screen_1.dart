...
class Screen1 extends StatefulWidget {
  ...
  const Screen1({Key? key, required this.handleBackButton, required this.handleEMIPlan}) : super(key: key);
...
class _Screen1State extends State<Screen1> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    slideAnimation = Tween<double>(begin: 0.0, end: 0.78).animate(slideController);
    ...
    return Stack(
      children: [
        Column(
          children: [
            _hudElement(),
            ChangeNotifierProvider.value(value: provider, child: _stackPopupContent()),
          ],
        ),
  ...
  Widget _hudElement() {
    return Column(
      children: [
        SizedBox(
          height: MediaQueryUtil.getPaddingTop() + MediaQueryUtil.getValueInPixel(100),
        ),
        Row(
          children: [
  ...
  Widget _howMuchWidget() {
    return CommonWidgets.FontWidget(StringConstants.howMuchDoYouWant, Colors.white, FontWeight.w500, "Roboto", FontStyle.normal, 80, TextAlign.left);
  }

  Widget _selectBankWidget() {
    return CommonWidgets.FontWidget(StringConstants.anyAmount, Colors.white.withOpacity(0.6), FontWeight.w500, "Roboto", FontStyle.normal, 60, TextAlign.left);
  }

  List<Widget> _selectedAmountWidget() {
    List<Widget> li = [];
    li.add(CommonWidgets.FontWidget(StringConstants.selectedAmount, Colors.white.withOpacity(0.5), FontWeight.w400, "Roboto", FontStyle.normal, 60, TextAlign.left));
